...
public class Editor_CharacterMaker : EditorWindow
{
    ...
    void DrawMainCharacterSettings() 
    {
        ...
        EditorGUILayout.BeginHorizontal();
        _newProfile.MoveVelocity = (float)EditorGUILayout.Slider("Move Speed:", _newProfile.MoveVelocity,0.1f,1f);
        EditorGUILayout.EndHorizontal();
    ...
    void CheckAllBooleans() 
    {
        try
        {
            ...
            filledMoveVelocity = _newProfile.MoveVelocity > 0.1f ? true : false;
